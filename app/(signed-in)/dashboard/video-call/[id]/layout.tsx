      ...
      <StatusCard
        ...
        action={
          <button 
            ...
            duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus-ring-ring-offset-2"
          >
            Retry 
          </button>  
        }
    ...
    return (
      <StatusCard title="Joining call..." className="min-h-screen bg-green-50" >
        <div className="animate-bounce h-16 w-16 mx-auto">
          <div className="w-16 h-16 bg-greeen-200 rounded-full flex items-center justify-center">
            <Video className="text-green-600 font-mono text-sm bg-green-100 px-3 py-1 rounded-full inline-block" />
          </div>
        </div>
